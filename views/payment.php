	...
	<div class="row payment-form">
		...
		<hr/>
				...
				<div class="form-group row">
					...
					<input type="text" class="form-control col-sm-8" name="cardHolderName"
						id="cardHolderName">
				</div>
				<div class="form-group row">
					<label for="expiryDate" class="col-sm-3 col-form-label">Expiry Date: </label>
					<label for="month" class="col-sm-1 col-form-label">Month: </label> <select class="form-control col-sm-3"
						id="month">
						<option>1</option>
						<option>2</option>
						<option>3</option>
					...
					<label for="year" class="col-sm-1 col-form-label">Year: </label> <select class="form-control col-sm-3"
						id="year">
						<option>20</option>
						<option>21</option>
						<option>22</option>
				...
				<div class="form-group row">
					<label for="csvSecurity" class="col-sm-3 col-form-label">CSV/Security Code:</label>
					<input type="text" class="form-control col-sm-8" name="csvSecurity"
						id="csvSecurity">
				</div>
			
			<div class="form-group row">
					<label for="billingAddress" class="col-sm-3 col-form-label" >Billing Address: </label>
					<input type="text" class="form-control col-sm-6" name="billingAddress"
						id="billingAddress">
					<button type="button"
						class="btnAddBillingAddress btn-primary">Add Billing
						Address</button>
				</div>
		...
		<div class="form-group row">
				<label for="name" class="col-sm-3 col-form-label">Product Name:<?php echo $productName; ?></label>
				
		</div>
		<div class="form-group row">
				<label for="price" class="col-sm-3 col-form-label">Price: </label>
				<input type="text" class="form-control col-sm-8" name="price"
					id="price">
		</div>
		</div>
		</div>
