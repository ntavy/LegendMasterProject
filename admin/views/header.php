...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo dirname($_SERVER['PHP_SELF']) ?>/public/css/admin-style.css">
	...
	<div class="header">
		<div class="menu">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
			  <a class="navbar-brand" href="<?php echo dirname($_SERVER['PHP_SELF']) ?>"><img src="<?php echo dirname($_SERVER['PHP_SELF']) ?>/public/images/legend-coffee-logo.png" class="img-fluid navbar-img" /></a>
