...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 18, 2020 at 09:18 AM
...
INSERT INTO `contactus` (`contactID`, `sendDate`, `message`) VALUES
(1, '2020-09-18 00:00:00', 'This is a test message.'),
(2, '2020-09-18 16:47:32', 'test message...');
...
--
-- Dumping data for table `personalcustomer`
--

INSERT INTO `personalcustomer` (`perCusID`, `firstName`, `lastName`, `dateOfBirth`, `shippingAddID`, `billingAddID`, `phone`, `email`, `company`, `addedDate`) VALUES
(1, 'Test', 'Customer', NULL, NULL, NULL, NULL, 'abc@gmail.com', 'Test Company', '2020-09-18 00:00:00'),
(2, 'Test', 'Customer', NULL, NULL, NULL, NULL, 'abc@gmail.com', 'Test Company', '2020-09-18 16:47:32');
...
--
ALTER TABLE `personalcustomer`
  MODIFY `perCusID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `contactus`
  ADD CONSTRAINT `contactus_ibfk_1` FOREIGN KEY (`contactID`) REFERENCES `personalcustomer` (`perCusID`);
